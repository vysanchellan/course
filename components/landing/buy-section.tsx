        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Reveal>
            <div className="relative">
              ...
              <div className="group relative bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-xl p-8 flex flex-col hover:-translate-y-0.5 hover:shadow-lg transition-all">
                <div className="relative">
          ...
          <Reveal>
            <div className="relative">
              ...
              <div className="group relative bg-white/[0.04] backdrop-blur-xl border border-gold/30 rounded-xl p-8 flex flex-col hover:-translate-y-0.5 hover:shadow-lg transition-all">
